...
a.getScrollProgress=function(){return this.options.scroll_top/(e.length*this.options.item_height)*100||0};var w=function(b,c){var d=q(c)?c:[];d.length&&(e="append"==b?e.concat(d):d.concat(e),a.insertToDOM(e,h))};a.append=function(a){w("append",a)};a.prepend=function(a){w("prepend",a)};a.updateRow=function(i,h){e[i]=h};a.walkRows=function(c){for(var i=0,l=e.length;i<l;i++){e[i]=c.call(a,e[i],i)}}};n.prototype={constructor:n,fetchMarkup:function(){for(var b=[],a=this.getChildNodes(this.content_elem);a.length;)b.push(a.shift().outerHTML);return b},exploreEnvironment:function(b){var a=this.options;a.content_tag=
