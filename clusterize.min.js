...
a.getScrollProgress=function(){return this.options.scroll_top/(e.length*this.options.item_height)*100||0};var w=function(b,c){var d=q(c)?c:[];d.length&&(e="append"==b?e.concat(d):d.concat(e),a.insertToDOM(e,h))};a.append=function(a){w("append",a)};a.prepend=function(a){w("prepend",a)};a.updateRow=function(i,h){e[i]=h};a.walkRows=function(c){for(var i=0,l=e.length;i<l;i++){e[i]=c.call(a,e[i],i)}};a.eachRows=function(c){for(var i=0,l=e.length;i<l;i++){if(c.call(a,e[i],i)===!1)break}}};n.prototype={constructor:n,fetchMarkup:function(){for(var b=[],a=this.getChildNodes(this.content_elem);a.length;)b.push(a.shift().outerHTML);return b},exploreEnvironment:function(b){var a=this.options;a.content_tag=
...
var a=document.createElement(b.tag),c=document.createTextNode(b.no_data_text),d;a.className=b.no_data_class;"tr"==b.tag&&(d=document.createElement("td"),d.colspan=50,d.appendChild(c));a.appendChild(d||c);return[a.outerHTML]},generate:function(b,a){var c=this.options,d=b.length;if(d<c.rows_in_block)return{rows_above:0,rows:d?b:this.generateEmptyRow()};c.cluster_height||this.exploreEnvironment(b);var f=Math.max((c.rows_in_cluster-c.rows_in_block)*a,0),k=f+c.rows_in_cluster,e=f*c.item_height,d=(d-k)*c.item_height,
